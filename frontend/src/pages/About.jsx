  ...
  return (
    <Container maxWidth="lg">
      <Box sx={{ py: 4 }}>
        ...
        {/* Mission Statement */}
        <Paper sx={{ p: 4, mb: 6, borderRadius: "16px", textAlign: "center" }}>
          ...
          >
            HepatoCAI is dedicated to improving hepatitis diagnosis, treatment,
            and patient outcomes through cutting-edge artificial intelligence
            technology. We believe that everyone deserves access to accurate,
            timely, and personalized healthcare solutions.
          </Typography>
        </Paper>
